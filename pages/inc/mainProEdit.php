<section id="mainPro">
	...
	<nav id="navPro">
		...
		<a href="?page=mainProView">view profil</a>
		<a href="?page=mainProDash">tableau de bord</a>
	</nav>
	...
	<div id="profilEdit">
		<form>
			...
			<select name="country">
				<option value="albanais" class="left">albanais</option>
				<option value="allemand">allemand</option>
				<option value="anglais">anglais</option>
				<option value="arabe">arabe</option>
				<option value="arménien">armenien</option>
				<option value="basque">basque</option>
				<option value="bengali">bengali</option>
				<option value="biélorusse">bielorusse</option>
