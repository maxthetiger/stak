<div id="main_container">
	<div id="infos_profil" class="container">
		<form id="fiche" method="POST" action="pages/inc/profil/edit.php">
			<div class="left" id="profil_img">
				<div id="pseudo_profil">
					<input class="pseudo_in" type="text" name="pseudo" value="<?php echo $pseudo; ?>" >
			<!-- <div id="pseudo_profil">
				...
				<div class="url_links">
					<div class="urls">
						...
						<span class="link_url">
							<input class="link_in" type="text" name="" value="<?php echo $github; ?>" >
						</span>
						<!-- <span class="link_url">
					...
					<div class="urls">
						...
						<span class="link_url">
							<input class="link_in" type="text" name="" value="<?php echo $webSite; ?>" >
						</span>
						<!-- <span class="link_url">
					...
					<div class="urls">
						...
						<span class="link_url">
							<input class="link_in" type="mail" name="" value="<?php echo $email; ?>" >
						</span>
						<!-- <span class="link_url">
